...
//static char *lvl_names[] = { "non", "crt", "err", "wrn", "inf", "dbg", "flw" };
static char *lvl_names[] = { "N", "C", "E", "W", "I", "D", "F" };
...
void LITE_syslog_routine(char *m, const char *f, const int l, const int level, const char *fmt, va_list *params)
{
    ...
    LITE_snprintf( tmpbuf, LOG_MSG_MAXLEN+1, LOG_PREFIX_FMT, lvl_names[level], f, l );
