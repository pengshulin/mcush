...
flash sectors for stm32f207xe (512kBytes total)
------------------------------------------
Sector 0,   // 16kbytes         ^ 
Sector 1,   // 16kbytes         |
Sector 2,   // 16kbytes         |
...
Sector 4,   // 64kbytes         |
Sector 5,   // 128kbytes        v
------------------------------------------
Sector 6,   // 128kbytes  <<< swap space
Sector 7,   // 128kbytes  <<< swap space
------------------------------------------
...
#define ADDR_SWAP    (0x08000000+256*1024)
#define ADDR_SIZE    (0x08000000+512*1024-4)
#define UPGRADE_FILE_SIZE_MIN   (10*1024)
#define UPGRADE_FILE_SIZE_MAX   (256*1024-4)
#define SECTOR_SWAP_BEGIN       6
#define SECTOR_SWAP_END         7
...
int hal_upgrade_prepare_swap( const char *filename, int debug_mode )
{
    ...
    IWDG_ReloadCounter();
    // erase sectors
    for( i=SECTOR_SWAP_BEGIN; i<=SECTOR_SWAP_END; i++ )
    {
