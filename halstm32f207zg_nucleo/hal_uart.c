...
int hal_uart_init(uint32_t baudrate)
{
    ...
    USART_ClearFlag( USART3, USART_FLAG_CTS | USART_FLAG_LBD | USART_FLAG_TC | USART_FLAG_RXNE );	
    USART_ITConfig( USART3, USART_IT_CTS | USART_IT_LBD | USART_IT_TXE | USART_IT_TC | \
