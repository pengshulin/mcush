...
#else       /*LV_MEM_CUSTOM*/
    #define LV_MEM_CUSTOM_INCLUDE     "mcush.h"
...
#define LV_TICK_CUSTOM 1
    ...
    #define LV_TICK_CUSTOM_INCLUDE          "mcush.h"
    #define LV_TICK_CUSTOM_SYS_TIME_EXPR    (os_tick()*OS_MS_PER_TICK)
...
#define LV_ASSERT_HANDLER_INCLUDE "mcush.h"
#define LV_ASSERT_HANDLER         halt( "lvgl: " __FILE__ );
