 ...
 */
    ...
    #define HAL_UART_RCC_GPIO_ENABLE_CMD    LL_IOP_GRP1_EnableClock
    #define HAL_UART_RCC_GPIO_ENABLE_BIT    LL_IOP_GRP1_PERIPH_GPIOA
    ...
    #define HAL_UARTx_TX_AF                 LL_GPIO_AF_1
