...
void scheme_set_input_port_file(scheme *sc, int fin_handle);
void scheme_set_input_port_string(scheme *sc, char *start, char *past_the_end);
SCHEME_EXPORT void scheme_set_output_port_file(scheme *sc, int fin_handle);
void scheme_set_output_port_string(scheme *sc, char *start, char *past_the_end);
SCHEME_EXPORT void scheme_load_file(scheme *sc, int fin_handle);
SCHEME_EXPORT void scheme_load_named_file(scheme *sc, int fin_handle, const char *filename);
...
struct scheme_interface {
  ...
  void (*load_file)(scheme *sc, int fin_handle);
