...
class LED4:
    ...
    def display_int( self, val, hex_mode=False ):
        if hex_mode:
    ...
    def display_seg( self, index, segment, ascii_mode=None, hex_mode=None ):
    ...
    def display_segs( self, index, segments, ascii_mode=None, hex_mode=None ):
