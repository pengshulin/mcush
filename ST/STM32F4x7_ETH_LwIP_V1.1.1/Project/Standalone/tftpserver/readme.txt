...
Please note that for tftp server demonstration, LwIP v1.4.1 is used as the TCP/IP stack.

@par Project Directory contents

 - "inc": contains the demonstration firmware header files
    - inc/ffconf.h             fatfs module configuration file
 ...
 - "src": contains the demonstration firmware source files
    - src/fatfs_drv.c          diskio interface
