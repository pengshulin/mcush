...
#define OS_PRIORITY_LOWEST       (RT_THREAD_PRIORITY_MAX-1)
#define OS_PRIORITY_MIN          (RT_THREAD_PRIORITY_MAX-1)
#define OS_PRIORITY_IDLE         (RT_THREAD_PRIORITY_MAX-1)
...
#define DEFINE_STATIC_QUEUE_BUFFER( name, queue_length, item_bytes )  \
    ...
    static uint8_t _static_queue_data_##name[queue_length*(RT_ALIGN(item_bytes,RT_ALIGN_SIZE)+RT_ALIGN_SIZE)];  \
